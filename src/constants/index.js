import {
  ...
  const projects = [
    {
      name: "MS Customer Managment",
      description:
        "It is a web application that facilitates the management of customer profiles and transactions. It includes automated email notifications for credit sales and presents data in a clear, tabulated format, enhancing user experience and streamlining business processes.",
      tags: [
        {
          name: "react",
      ...
      image: carrent,
      source_code_link: "https://github.com/nivask2003/MS-Customer-Management",
    },
    {
      name: "Murugan Stores",
      description:
        "Murugan Stores is a dynamic e-commerce website designed for seamless product purchases. It features an integrated shopping cart system that automatically sends order details to both the customer and the admin upon checkout, ensuring smooth communication and efficient management.",
      tags: [
        {
          name: "PHP",
          color: "blue-text-gradient",
    ...
    },
    {
      name: "Iraders",
      description:
        "Iraders is a dynamic web platform designed for the public, police, and ambulance services. It facilitates seamless communication between these groups, enhancing emergency response and coordination. The platform aims to improve public safety through efficient real-time interactions.",
      tags: [
        {
          name: "PHP",
          color: "blue-text-gradient",
